    ...
    <div class="well well-lg">
    		...
    		<thead>
     		...
     		?>
              ...
              ?>
                  <td><? echo "<a href='gestionProfesores.php?objDes=". $obj->email ."' class='btn btn-primary gestionBoton'> Desactivar </a> "; ?></td>
              <?php

                }else{

              ?>x
                <td><? echo "<a href='gestionProfesores.php?objActi=". $obj->email ."' class='btn btn-primary gestionBoton'> Activar </a> "; ?></td>
              <?php
