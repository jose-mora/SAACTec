...
(2, 'Con plaza', 'Escuela de computacion', 'Bachiller', '113570098', 'Jonathan', 'Mendez', 'Baltodano', 'jmendezb88@yahoo2.com', '88792303', '88792303', 70, 1, '25%', 'Calle Blancos', ''),
...
(7, 'Interino', 'Escuela de administracion', 'Bachiller', '115060798', 'Sugey', 'M̩ndez', 'Baltodano', 'saced@saactec.com', '83156732', '87430954', 70, 0, '50%', 'Calle Blancos', '1'),
(8, 'Con plaza', 'Escuela de computacion', 'Bachiller', '800600912', 'Norma', 'Baltodano', 'Martinez', 'norma@tec.com', '88440700', '20009876', 70, 1, '25%', 'Calle Blancos, goicoechea', '1');
...
--
-- Estructura de tabla para la tabla `procesoasignacion`
--

CREATE TABLE IF NOT EXISTS `procesoasignacion` (
...
--
-- Volcado de datos para la tabla `procesoasignacion`
--

INSERT INTO `procesoasignacion` (`idProcesoAsignacion`, `nombre`, `activo`) VALUES
(4, 'semestre 1 2015', 0),
(5, 'cuatrimestre 1 2015', 0);
...
--
-- Indices de la tabla `procesoasignacion`
--
ALTER TABLE `procesoasignacion`
 ADD PRIMARY KEY (`idProcesoAsignacion`);
...
--
-- AUTO_INCREMENT de la tabla `procesoasignacion`
--
ALTER TABLE `procesoasignacion`
MODIFY `idProcesoAsignacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;


--------------------------------------------------------

--
-- Estructura de tabla para la tabla `resultadoprocasignacion`
--

CREATE TABLE IF NOT EXISTS `resultadoprocasignacion` (
...
--
-- Indices de la tabla `resultadoprocasignacion`
--
ALTER TABLE `resultadoprocasignacion`
...
--
-- AUTO_INCREMENT de la tabla `resultadoprocasignacion`
--
ALTER TABLE `resultadoprocasignacion`
MODIFY `idResultado` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
