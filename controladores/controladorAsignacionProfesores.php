  ...
  include('objetos/obj_nota.php');
	...
	class controladorAsignacionProfesores {
          ...
          function asignarProfesores($obj){
            ...
            foreach ($listaGrupos as $grupo){
              ...
              if (count($listaProfesores) > 0) {
                ...
                $encontro = $this->busquedaXPrioridad($listaConPlaza, $grupo->ideGrupo);

                //si no encontro, entramos a verificar los interinos
                if (!$encontro) {
                  echo "No encontro con plaza, buscando con interinos <br/>";
                  $encontro = $this->busquedaXPrioridad($listaInterinos, $grupo->ideGrupo);  
        ...
        //-------------------------------------------------------------------------------------------------------------------------
          ...
          function busquedaXPrioridad($listaProfesores, $grupo){
            ...
            if (count($listaProfesoresAceptados)>0) {
              ...
              if (count($listaProfesoresAceptados) == 1) { //solo existe un profesor, por tanto es el indicado
                  ...
                  $encontro = $this->buscaProfesorConMejorNota($listaProfesoresAceptados,$grupo);
              }
            }
          ...
          function buscaProfesorConMejorNota($listaProfesores,$grupo){
